...
const MODES = [
  { id: "optimize" as Mode, label: "Optimizar texto", context: "experience", placeholder: "Hice una app web para gestion de tareas con usuarios y login..." },
  { id: "summary" as Mode, label: "Generar resumen", context: "summary", placeholder: "6 anos de experiencia, especialista en React y Node.js..." },
  { id: "ats" as Mode, label: "Mejorar para ATS", context: "ats", placeholder: "Construi microservicios y los desplegue en produccion..." },
];

const TEMPLATES = [
  { label: "Experiencia laboral", text: "Mane un equipo de desarrolladores y trabaje en el sitio web de la empresa mejorando el rendimiento" },
  { label: "Logro cuantificable", text: "Ayude a reducir el tiempo de carga del dashboard principal" },
  { label: "Proyecto personal", text: "Hice una app de e-commerce con pagos y gestion de usuarios" },
  { label: "Habilidades", text: "Se React, trabaje un poco con Docker y use REST APIs" },
];
...
export default function AIAssistantPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      toast.success("Optimizacion completa!");
    } catch {
      setOutput({
        text: "Desarrolle y mantuve aplicaciones web de alto rendimiento utilizando frameworks modernos, logrando una mejora del 40% en eficiencia del sistema y entregando experiencias de usuario excepcionales.",
        improvements: ["Verbos de accion fuertes", "Metricas cuantificables incluidas", "Keywords ATS mejoradas"],
      });
      toast.info("Demo — levanta Ollama para IA real: ollama serve");
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="p-5 rounded-2xl border border-border bg-card space-y-3">
            ...
            <button onClick={run} disabled={loading}
              ...
              {loading
                ? <><Loader2 size={15} className="animate-spin" />Procesando con Ollama...</>
                : <><Sparkles size={15} />Optimizar con IA</>
              }
            </button>
          </div>
              ...
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
                ...
                {loading
                  ? <div className="flex items-center gap-3 text-sm text-muted-foreground">
                    <Loader2 size={15} className="animate-spin text-primary" />Generando con Mistral 7B...
                  </div>
                  : <>
        ...
        <div className="space-y-5">
          <div className="p-5 rounded-2xl border border-border bg-card">
            <h3 className="text-sm font-semibold mb-4">Plantillas rapidas</h3>
